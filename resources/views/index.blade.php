...
<div class="login hidden z-50 bg-white w-11/12 max-w-xl sm:w-10/12 md:w-9/12 fixed -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 card p-5 gap-5">
    ...
    <div class="login-error hidden text-center w-full bg-red-200 py-3 rounded-md">
        <p>Username or Password Incorrect!</p>
    </div>
    <div class="login-forms w-full flex flex-col gap-5">
        <form class="flex flex-col gap-3">
            <div class="user-id flex flex-col gap-1">
            ...
            <div class="user-password flex flex-col gap-1">
        ...
        <div class="user-remember flex flex-col items-center gap-1">
...
<div class="success-addproduct hidden fixed z-50 w-11/12 md:w-9/12 -translate-x-1/2 left-1/2 overflow-hidden card">
    ...
    <div class="card h-full justify-start col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-3">
        ...
        <div class="card-body">
            ...
            <form class="flex items-center justify-center gap-2 justify-self-end">
                <input name="quantity" id="quantity" class="w-full h-full px-3 button  bg-white border-2 border-black/50 focus:bg-gray-300 text-black hover:bg-white" type="number" min="1" value="1">
